define([
  ...
  class loadCandidatesForSuccessorsChain2 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors2',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse2',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors2 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain2;
});
