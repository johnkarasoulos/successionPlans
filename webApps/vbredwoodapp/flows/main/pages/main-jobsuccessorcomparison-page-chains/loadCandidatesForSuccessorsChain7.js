define([
  ...
  class loadCandidatesForSuccessorsChain7 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors7',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse7',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors7 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain7;
});
