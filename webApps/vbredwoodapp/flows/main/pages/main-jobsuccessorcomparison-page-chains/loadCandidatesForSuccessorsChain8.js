define([
  ...
  class loadCandidatesForSuccessorsChain8 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors8',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse8',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors8 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain8;
});
