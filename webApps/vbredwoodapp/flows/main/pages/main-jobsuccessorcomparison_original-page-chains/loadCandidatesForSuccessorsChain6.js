define([
  ...
  class loadCandidatesForSuccessorsChain6 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors6',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse6',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors6 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain6;
});
