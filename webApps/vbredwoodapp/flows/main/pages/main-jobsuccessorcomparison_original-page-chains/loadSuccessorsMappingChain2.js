define([
  ...
  class loadSuccessorsMappingChain2 extends ActionChain {
    ...
    async run(context, { successorsMappingId }) {
      ...
      if (true && successorsMappingId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.successorsMapping2',
          ],
        ...
        const callRestGetSuccessorsMappingResult = await Actions.callRest(context, {
          ...
          responseType: 'getSuccessorsMappingResponse2',
          uriParams: {
        ...
        if (callRestGetSuccessorsMappingResult.ok) {
          ...
          $page.variables.successorsMapping2 = callRestGetSuccessorsMappingResult.body;
        } else {
  ...
  return loadSuccessorsMappingChain2;
});
