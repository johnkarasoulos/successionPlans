define([
  ...
  class loadCandidatesForSuccessorsChain4 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors4',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse4',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors4 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain4;
});
