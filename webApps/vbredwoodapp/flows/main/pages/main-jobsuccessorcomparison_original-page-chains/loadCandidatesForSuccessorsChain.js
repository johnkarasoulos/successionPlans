define([
  ...
  class loadCandidatesForSuccessorsChain extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain;
});
