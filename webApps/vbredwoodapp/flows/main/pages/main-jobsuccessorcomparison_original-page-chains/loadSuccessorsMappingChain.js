define([
  ...
  class loadSuccessorsMappingChain extends ActionChain {
    ...
    async run(context, { successorsMappingId }) {
      ...
      if (true && successorsMappingId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.successorsMapping',
          ],
        ...
        const callRestGetSuccessorsMappingResult = await Actions.callRest(context, {
          ...
          responseType: 'getSuccessorsMappingResponse',
          uriParams: {
        ...
        if (callRestGetSuccessorsMappingResult.ok) {
          ...
          $page.variables.successorsMapping = callRestGetSuccessorsMappingResult.body;
        } else {
  ...
  return loadSuccessorsMappingChain;
});
