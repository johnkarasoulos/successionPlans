define([
  ...
  class loadCandidatesForSuccessorsChain5 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors5',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse5',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors5 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain5;
});
