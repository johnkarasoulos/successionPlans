define([
  ...
  class loadCandidatesForSuccessorsChain9 extends ActionChain {
    ...
    async run(context, { candidatesForSuccessorsId }) {
      ...
      if (true && candidatesForSuccessorsId !== undefined) {
        ...
        await Actions.resetVariables(context, {
          variables: [
            '$page.variables.candidatesForSuccessors9',
          ],
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          responseType: 'getCandidatesForSuccessorsResponse9',
          uriParams: {
        ...
        $page.variables.candidatesForSuccessors9 = callRestResult.body;
      }
    }
  }

  return loadCandidatesForSuccessorsChain9;
});
